...
public class GiftAHorse extends GiftNpc {

	{
		//name = Messages.get(this,"name");
		spriteClass = AHorseSprite.class;
	...
	public void givereward(NPC npc) {
		...
		switch (this.FRIEND) {
			case 100 :
				Dungeon.depth.drop(new DewWaterGun(),Dungeon.hero.pos).sprite.drop();
