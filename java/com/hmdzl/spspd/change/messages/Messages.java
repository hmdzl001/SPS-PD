...
import com.hmdzl.spspd.change.SPSSettings;
...
public class Messages {
	...
	private static String[] prop_files = new String[]{
			"com.hmdzl.spspd.change.messages.actors.actors",
			"com.hmdzl.spspd.change.messages.items.items",
			"com.hmdzl.spspd.change.messages.levels.levels",
			"com.hmdzl.spspd.change.messages.plants.plants",
			"com.hmdzl.spspd.change.messages.scenes.scenes",
			"com.hmdzl.spspd.change.messages.ui.ui",
			"com.hmdzl.spspd.change.messages.windows.windows",
			"com.hmdzl.spspd.change.messages.misc.misc"
	};
	...
	public static String get(Class c, String k, Object...args){
		String key;
		if (c != null){
			key = c.getName().replace("com.hmdzl.spspd.change.", "");
			key += "." + k;
		} else
			key = k;
