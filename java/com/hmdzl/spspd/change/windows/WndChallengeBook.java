...
public class WndChallengeBook extends Window {
	...
	private static final String TXT_FARAWELL = Messages.get(WndChallengeBook.class,"title");
	...
	public WndChallengeBook(final boolean[] rooms, final ChallengeBook item) {
