	...
	public void explode(int cell) {
		...
		//}
			...
			if (c >= 0 && c < Level.getLength()) {
				...
				if (ch != null && !(ch instanceof NPC) && !(ch instanceof BlueWraith) && !(ch instanceof Wraith) && !(ch instanceof RedWraith) && !(ch instanceof Sentinel) && !(ch instanceof FlyingProtector) && !(ch instanceof Golem) && !(ch instanceof Skeleton) && !(ch instanceof DwarfLich) && !(ch instanceof Statue) && !(ch instanceof Yog) && !(ch instanceof ShadowYog) && !(ch instanceof Fiend) && ch != Dungeon.hero) {
