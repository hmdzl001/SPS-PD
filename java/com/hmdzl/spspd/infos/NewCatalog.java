...
import com.hmdzl.spspd.items.armor.normalarmor.CatSharkArmor;
...
public enum NewCatalog {
	...
	static {
		...
		WEAPONS.seen.put( XiXiBox.class , true);
		WEAPONS.seen.put( HolyMace.class , true);
		WEAPONS.seen.put( AFlySock.class , true);
		...
		ARMOR.seen.put( CatSharkArmor.class, true);
