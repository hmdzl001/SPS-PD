...
public class HeroSelectScene extends PixelScene {
	...
	public void create() {
		...
		Badges.loadingListener = new Callback() {
			@Override
			public void call() {
				if (Game.scene() == HeroSelectScene.this) {
    ...
    private void askSkin() {
		...
		HeroSelectScene.this.add( new WndSkinSkin() );
    }	

	private void startNewGame( int skin ) {

		Dungeon.hero = null;
		//Dungeon.hero.skins = skin;
	...
	private class ChallengeButton extends Button {
		...
		@Override
		protected void onClick() {
			HeroSelectScene.this.add(new WndChallenges(ShatteredPixelDungeon.challenges(), true) {
    ...
    private class WndSkinSkin extends WndSkinImageOptions {
     ...
     @Override
        protected void onSelect( int index ) {
			final int skins = index;
            final String skin = Skins.NAME_IDS[index];
		    HeroSelectScene.this.add(
