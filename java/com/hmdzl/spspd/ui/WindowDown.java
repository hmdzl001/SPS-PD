...
public class WindowDown extends Group implements Signal.Listener<Key> {
	...
	public WindowDown(int width, int height) {
		this(width, height, Chrome.get(Chrome.Type.WINDOW));
	}

	public WindowDown(int width, int height, NinePatch chrome) {
		super();
		...
		blocker = new TouchArea(0, 0, PixelScene.uiCamera.width,
			...
			protected void onClick(Touch touch) {
				if (!WindowDown.this.chrome.overlapsScreenPoint(
	...
	public void resize(int w, int h) {
		...
		camera.y = (int) (Game.height - camera.screenHeight()) / 10*7;
