...
public class ToolbarOld extends Component {
	...
	public ToolbarOld() {
		...
		toolslots = ShatteredPixelDungeon.quicktypes();
	...
	protected void layout() {
		...
		if (ShatteredPixelDungeon.landscape()){
            ...
            btnQuick3.setPos(width - btnInventory.width()*7+7, y);
            ...
            btnQuick9.setPos(width - btnQuick.width(), btnQuick.height()*6-5);
		}
	...
	public void update() {
		...
		// one is visible...
		if ((toolslots == 1) == btnQuick2.visible) {
			layout();
		}
	}
