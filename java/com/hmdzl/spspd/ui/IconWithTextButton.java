...
public class IconWithTextButton extends Button {
	...
	public IconWithTextButton( String label ) {
		this(label, 6);
	}

	public IconWithTextButton( Image image, String label ) {
		super();
		icon = image;
		add(icon);

		text = PixelScene.renderText( 6 );
		text.text( label );
		add( text );
	}

	public IconWithTextButton( String label, int size ){
		super();
	...
	public IconWithTextButton(Image image, String label, int size ){
		super();
	...
	protected void createChildren() {
		...
		bg = Chrome.get( Chrome.Type.STATE_BUTTON );
		add( bg );
	}
