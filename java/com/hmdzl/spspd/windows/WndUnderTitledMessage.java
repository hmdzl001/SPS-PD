...
public class WndUnderTitledMessage extends WindowDown {
	...
	public WndUnderTitledMessage( Image icon, String title, String message ) {

		this( new IconTitle( icon, title ), message );

	}

	public WndUnderTitledMessage( Component titlebar, String message ) {
