...
public class WndGameInProgress3 extends Window {
	...
	public WndGameInProgress3(final int slot){
		...
		RedButton cont = new RedButton(Messages.get(this, "continue")){
			...
			protected void onClick() {
				...
				ShatteredPixelDungeon.scene().add(new WndOptions(
						Messages.get(WndGameInProgress3.class, "continue_warn_title"),
						Messages.get(WndGameInProgress3.class, "continue_warn_body"),
						Messages.get(WndGameInProgress3.class, "continue_warn_yes"),
						Messages.get(WndGameInProgress3.class, "continue_warn_no") ) {
					@Override
					protected void onSelect( int index ) {
						if (index == 0) {
							...
							InterlevelScene.mode = InterlevelScene.Mode.OVERLOAD;
