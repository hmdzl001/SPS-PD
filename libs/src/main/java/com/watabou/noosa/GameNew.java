...
public class GameNew extends Activity implements GLSurfaceView.Renderer, View.OnTouchListener {
	...
	protected Game.SceneChangeCallback onChange;
	...
	public GameNew(Class<? extends Scene> c ) {
		super();
		sceneClass = c;
	}
	...
	public static void switchScene(Class<? extends Scene> c, Game.SceneChangeCallback callback) {
	...
	protected void switchScene() {
		...
		GameNew.elapsed = 0f;
		GameNew.timeScale = 1f;
	}
	
	protected void update() {
		GameNew.elapsed = GameNew.timeScale * step * 0.001f;
