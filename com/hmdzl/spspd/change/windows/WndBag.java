...
public class WndBag extends WndTabbed {
	...
	public static enum Mode {
		...
		NOTREINFORCED, UPGRADEDEW, JOURNALPAGES, SHOES
	}
			...
			if (item != null) {
				...
				if (item.name() == null) {
					...
					enable(mode == Mode.FOR_SALE
							...
							|| mode == Mode.WEAPON
							&& (item instanceof MeleeWeapon || item instanceof Boomerang || item instanceof JupitersWraith || item instanceof ErrorT)
							|| mode == Mode.ARMOR
							&& (item instanceof Armor)
							|| mode == Mode.ENCHANTABLE
							&& (item instanceof MeleeWeapon	|| item instanceof Boomerang || item instanceof Armor  || item instanceof ErrorT)
