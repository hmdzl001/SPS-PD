...
import com.hmdzl.spspd.change.actors.buffs.PinCushion;
...
public class MissileWeapon extends Weapon {
	...
	protected void onThrow(int cell) {
		...
		if (enemy == null || enemy == curUser) {
			if (this instanceof Boomerang || this instanceof JupitersWraith || this instanceof ErrorT )
				super.onThrow(cell);
			else
				miss(cell);
		} else {
			if (!curUser.shoot(enemy, this)) {
				miss(cell);
			} else if (!(this instanceof Boomerang || this instanceof JupitersWraith || this instanceof ErrorT )) {
				int bonus = 0;
