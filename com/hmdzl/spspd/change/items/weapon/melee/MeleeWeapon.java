...
public class MeleeWeapon extends Weapon {
	...
	public MeleeWeapon(int tier, float acu, float dly, int rch) {
		super();
	...
	public String info() {
		...
		switch (imbue) {
		case LIGHT:
			info += "\n\n" + Messages.get(MeleeWeapon.class, "lighter");
			break;
		case HEAVY:
			info += "\n\n" + Messages.get(MeleeWeapon.class, "heavier");
			break;
		case NONE:
		}
		...
		if (reinforced) {
			info += "\n\n" + Messages.get(MeleeWeapon.class, "reinforced");
		}
