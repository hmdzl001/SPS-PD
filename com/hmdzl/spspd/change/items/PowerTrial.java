...
public class PowerTrial extends Item {
	...
	public void execute(Hero hero, String action) {
		...
		if (action == AC_PORT) {
			...
			if (Dungeon.depth==specialLevel && hero.pos != Dungeon.level.exit && Dungeon.wings == false) {
				hero.spend(TIME_TO_USE);
				GLog.w(Messages.get(Item.class, "item_first"));
				return;
			}
