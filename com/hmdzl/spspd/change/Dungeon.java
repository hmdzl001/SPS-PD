...
public class Dungeon {
	...
	public /*static*/ enum limitedDrops {
		...
		armband, spork, runicblade, sewerkey, prisonkey, caveskey, citykey, hallskey, ringofwealth, vaultpage, town,
		conchshell, ancientcoin, tengukey, bone, journal, safespotpage, dragoncave, treasuremap,

		// containers
		dewVial, seedBag, scrollBag, potionBag, wandBag, shopcart;
...
public static Level newJournalLevel(int page, Boolean first){
	...
	public static Level newLevel() {
		...
		Statistics.qualifiedForNoKilling = !bossLevel();
		if (depth<25 && depth!=21 && !Dungeon.bossLevel(depth) && (Dungeon.dewDraw || Dungeon.dewWater)){
