...
public class GnollKing extends Mob {
    ...
    public boolean act() {
		...
		if (breaks > 0){
			...
			Gnoll1.spawnAroundChance(newPos);
		    }  	
		}
        return super.act();
    }
	...
	public void die(Object cause) {
		...
		yell(Messages.get(this,"treasure"));
	...
	public static class Gnoll1 extends Mob {
	...
	public static Gnoll1 spawnAt(int pos) {
		
        Gnoll1 g1 = new Gnoll1();  
